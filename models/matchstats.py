...
class PlayerStats(db.Model):
    ...
    player_id = db.Column(db.Integer, db.ForeignKey('player.id'))  # Adjust table name if different
    match_id = db.Column(db.Integer, db.ForeignKey('match.id'))    # Adjust table name if different
